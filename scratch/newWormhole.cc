...
#pragma GCC diagnostic ignored "-Wunused-variable"
    ...
    bool enableRttWormholeDetect = false;
    m_protocolName = "protocol";

    CommandLine cmd;
    cmd.AddValue("EnableMonitor", "Enable Flow Monitor", enableFlowMonitor);
    cmd.AddValue("phyMode", "Wifi Phy mode", phyMode);
    cmd.AddValue("EnableRttWormholeDetect", "Enable online RTT-based wormhole detection", enableRttWormholeDetect);
    ...
    //Wormhole detection
    aodv.Set("EnableRttWormholeDetect", BooleanValue(enableRttWormholeDetect));
    malicious_aodv.Set("EnableRttWormholeDetect", BooleanValue(enableRttWormholeDetect));
    //Wormhole detection
    ...
    AnimationInterface anim("./output/wormhole_anim.xml"); // Mandatory
    ...
    Ptr<OutputStreamWrapper> routingStream = Create<OutputStreamWrapper>("./output/wormhole.routes", std::ios::out);
    ...
    std::ofstream o1;
    o1.open("./output/TwormholeDesc.txt", std::ios_base::app);
    ...
    monitor->SerializeToXmlFile("./output/lab-4.flowmon", true, true);
